...
public class FillRandByPrice implements MenuOption {
    private String name;
    FillRandByPrice(String name){
        this.name=name;
    }
    ...
    public void execute() {
        ...
        Van van = addVan();
        System.out.print("Введіть максимальну вартість вмісту: ");
        van.fillRand("price",getInt());
